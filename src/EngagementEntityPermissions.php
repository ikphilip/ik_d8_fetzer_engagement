...
use Drupal\ik_d8_fetzer_engagement\Entity\EngagementEntityType;

/**
 * Provides dynamic permissions for nodes of different types.
 */
class EngagementEntityPermissions {
  ...
  public function entityTypePermissions() {
    ...
    foreach (EngagementEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\node\Entity\EngagementEntityType $type
   *   The node type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(EngagementEntityType $type) {
    $type_id = $type->id();
